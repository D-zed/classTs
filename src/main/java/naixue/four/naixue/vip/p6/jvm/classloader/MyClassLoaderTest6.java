...
public class MyClassLoaderTest6 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        ...
        //这个仅仅重写了findClass
        MyClassLoader5 myClassLoader1 = new MyClassLoader5(classLoader);
        myClassLoader1.findClass("F:/myClassLoader/zhouyang/juc/thread/newthread/classloader/HelloWorld");
        ...
        Class<?> aClass = myClassLoader.loadClass("naixue.four.naixue.vip.p6.jvm.classloader.HelloWorld");
